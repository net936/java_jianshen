...
import { createApi, listApi, updateApi, deleteApi } from '/@/api/qicai';
...
const columns = reactive([
  ...
  },
  {
    ...
    dataIndex: 'status',
    key: 'status',
    customRender: ({ text, record, index, column }) => (text === '0' ? '正常' : '报废'),
  },
  {
    title: '操作',
    dataIndex: 'action',
