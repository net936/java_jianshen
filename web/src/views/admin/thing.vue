        ...
        <div>
          <a-form ref="myform" :label-col="{ style: { width: '80px' } }" :model="modal.form" :rules="modal.rules">
            <a-row :gutter="24">
              ...
              <a-col span="24">
                <a-form-item label="课程分类" name="classificationId">
                  <a-select
                    placeholder="请选择"
                    allowClear
                    :options="modal.cData"
              ...
              <a-col span="24">
                <a-form-item label="课程教练" name="teacherId">
                  <a-select
                    placeholder="请选择"
                    allowClear
                    :options="modal.dData"
                    :field-names="{ label: 'title', value: 'id' }"
                    v-model:value="modal.form.teacherId"
                  />
                </a-form-item>
              </a-col>
              <a-col span="24">
              ...
              <a-col span="12">
                <a-form-item label="目标效果">
                  <a-input placeholder="请输入" v-model:value="modal.form.xiaoguo" style="width: 100%" />
                </a-form-item>
              </a-col>
              <a-col span="12">
...
<script setup>
  ...
  import { listApi as listTeacherApi } from '/@/api/teacher';
    ...
    myform.value
      ...
      .then(() => {
        ...
        if (modal.form.teacherId) {
          formData.append('teacherId', modal.form.teacherId);
        }
        ...
        formData.append('xiaoguo', modal.form.xiaoguo || '');
