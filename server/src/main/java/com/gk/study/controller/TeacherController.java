...
public class TeacherController {
    ...
    @Transactional
    public APIResponse create(Teacher teacher) throws IOException {
        String image = saveCover(teacher);
    ...
    @Transactional
    public APIResponse update(Teacher teacher) throws IOException {
        String image = saveCover(teacher);
        if(!StringUtils.isEmpty(image)) {
            teacher.cover = image;
        }
    ...
    public String saveCover(Teacher teacher) throws IOException {
        MultipartFile file = teacher.getImageFile();
